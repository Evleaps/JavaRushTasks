...
public class Solution {
    public static void main(String[] args) {
        ...
        PersonRoman roman = new PersonRoman("Роман");
        for (Money money : ivan.getAllMoney()) {
            System.out.println(ivan.name + " имеет заначку в размере " + money.getAmount() + " " + money.getCurrencyName());
        }
        for (Money money : roman.getMoneyRoman()) {
            System.out.println(roman.name + " имеет заначку в размере " + money.getAmount() + " " + money.getCurrencyName());
        }
    }
    ...
    static class Person {
        ...
        Person(String name) {
            ...
            //добавил классы
            allMoney.add(new USD(50.567));
            allMoney.add(new Ruble(20000.1));
            allMoney.add(new Hrivna(100.5));
            }
