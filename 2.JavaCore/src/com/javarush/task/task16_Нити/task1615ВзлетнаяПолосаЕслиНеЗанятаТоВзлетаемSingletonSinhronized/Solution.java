package com.javarush.task.task16_Нити.task1615ВзлетнаяПолосаЕслиНеЗанятаТоВзлетаемSingletonSinhronized;
...
public class Solution {
    ...
    public static class Runway { //взлетная полоса
        ...
        //не совсем понял как работает этот класс, тут, очевидно Singleton, который запрещает
        // потокам разом использовать класс одновременно, но есть чувство, что это можно упростить, но хз как
