package com.javarush.task.task18_Обертки_CrUD_Округление_ПодсчетСимволов.task1821_ВстречаемостьСимволов;
...
//        FileInputStream inputStream = new FileInputStream("C:/My programs/Coding/JavaRushTasks/2.JavaCore/src/com/javarush/task/task18_Обертки_CrUD_Округление_ПодсчетСимволов/task1821_ВстречаемостьСимволов/1.txt");
