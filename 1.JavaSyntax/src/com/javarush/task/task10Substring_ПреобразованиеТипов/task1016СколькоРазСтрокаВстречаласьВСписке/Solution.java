package com.javarush.task.task10Substring_ПреобразованиеТипов.task1016СколькоРазСтрокаВстречаласьВСписке;
...
Результат нужно представить в виде словаря MapClass<String, Integer>, где первый параметр
