package com.javarush.task.task18_Обертки_CrUD_Округление_ПодсчетСимволов.task1811Обертка;
...
public class Solution {
    ...
    public static class DecoratorMyRunnableImpl implements Runnable {
        ...
        @Override
        public void run() {
            System.out.print(DecoratorMyRunnableImpl.class.getSimpleName() + " body ");
            component.run();
        }
    }
