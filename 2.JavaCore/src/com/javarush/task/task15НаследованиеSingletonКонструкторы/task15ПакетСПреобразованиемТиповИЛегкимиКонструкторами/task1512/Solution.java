package com.javarush.task.task15НаследованиеSingletonКонструкторы.task15ПакетСПреобразованиемТиповИЛегкимиКонструкторами.task1512;

/* 
Максимально простой код 2
осмотри, что, связанное с конструкторами, может быть добавлено при компиляции, но в этой программе уже присутствует.
