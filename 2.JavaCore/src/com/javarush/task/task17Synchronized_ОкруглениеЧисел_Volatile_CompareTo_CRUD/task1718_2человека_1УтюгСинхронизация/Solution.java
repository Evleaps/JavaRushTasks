package com.javarush.task.task17Synchronized_ОкруглениеЧисел_Volatile_CompareTo_CRUD.task1718_2человека_1УтюгСинхронизация;
...
public class Solution {
    ...
    public static class Person extends Thread { //Человек
        ...
        @Override
        public void run() {
            /*Одежда - личное, желание погладить - тоже личное.
