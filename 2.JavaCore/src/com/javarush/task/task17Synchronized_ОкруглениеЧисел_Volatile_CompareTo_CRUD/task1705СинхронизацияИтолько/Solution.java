package com.javarush.task.task17Synchronized_ОкруглениеЧисел_Volatile_CompareTo_CRUD.task1705СинхронизацияИтолько;
...
public class Solution {
    ...
    public static class Garden {
        ...
        //удаляет из vegetables элемент с индексом index
